...
export class ResPage implements OnInit {
  ...
  constructor(
    ...
    public httpClient: HttpClient,
      ...
      // api 들고 오기
      this.films = this.httpClient.get('https://api.odcloud.kr/api/nts-businessman/v1/validate?serviceKey=%09Bj4ox2avWwiO9K6C%252F2zmpE9xbtfGnWi%252BW%252ByRYiGJ0P5QOTAXsRqXTEr%252BlHImSxQN3bYlRFGMY9csmnw%252Fmw%252BoeQ%253D%253D&returnType=JSON');
      this.films
      .subscribe(data => {
  ...
  togglecheck() {
    ...
    this.checkmark = this.isDisabled ? 'checkmark-circle-outline' : 'checkmark-circle'
  }
      ...
      .then(async (userCredential) => {
        ...
        .then(async () => {
          ...
          await this.alertCtrl.create({
            ...
            message: "해당 이메일로 이메일 주소 인증을 보냈습니다. 이메일 주소 인증 이후 로그인을 진행하여 주세요.",
            buttons: [
            {
